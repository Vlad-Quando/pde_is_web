...
from .server_frames import PARAM_SETTING_COMMAND
...
def prepare_data() -> dict:
    ...
    try:
        message = PARAM_SETTING_COMMAND # Creating a message
        ...
        message['supressMode'] = random.randint(1, 6) # Putting a supress mode value
...
def send(connection) -> dict:
    ...
    try:
        ...
        return {'type': 'SENT', 'sentTo': connection.getpeername(), 'message': message}
